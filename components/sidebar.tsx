...
export function Sidebar({
  ...
  return (
    <aside className="flex w-16 shrink-0 flex-col border-r border-sidebar-border bg-sidebar md:w-60">
      <div className="flex h-16 items-center gap-2.5 border-b border-sidebar-border px-4 md:px-5">
        ...
        <div className="hidden flex-col leading-tight md:flex">
          <span className="text-sm font-semibold text-sidebar-foreground">Astraia</span>
          <span className="text-xs text-muted-foreground">Fetal Medicine</span>
        </div>
      </div>
